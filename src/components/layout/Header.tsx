          ...
          {navLinks.map(link => <NavLink key={link.href} {...link} />)}
           <div className="flex items-center gap-4 ml-4">
               <SocialIcon href="https://www.facebook.com/p/VI-MO-stahovanie-upratovanie-100063524682338/" ariaLabel="Facebook">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="currentColor"><title>Facebook</title><path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32V7.46H6.11v4.24h3.39v10.4h4.24V11.7h3.34l.57-4.24z"/></svg>
               </SocialIcon>
